!function(n, e) {
    ...
    , function(n, e, r) {
        ...
        var o, t = {
            ...
            for (var a = "", i = r.spell, u = 0; u < e.length; u++)
                if (0 === r.spell.indexOf(e[u])) {
                    a = e[u],
                    i = r.spell.substr(a.length);
                    break
                }
            return {
                spell: r.spell,
        ...
        var u = function() {
            ...
            var o = Array(n)
              , t = 0;
            for (e = 0; e < r; e++)
                for (var a = arguments[e], i = 0, u = a.length; i < u; i++,
                t++)
                    o[t] = a[i];
            return o
        };
                    ...
                    if (h(e)) {
                        ...
                        if (-1 !== c) {
                            ...
                            if (p.poly) {
                                ...
                                p.isPolyWord && t.spellDefault[e] && (p.res = S(t.spellDefault[e], i).spell),
                                u[n] = [p.res],
                                r[n] = ""
                        }
                    } else
        ...
        function T(n, e, r, o, t, a) {
            var i = parseInt(e[r + 1])
              , u = {
                res: n,
                poly: !1,
                isPolyWord: i >= 5
            };
            return o || t ? (u.isPolyWord && (i -= 5,
            o && (u.poly = !0)),
            t && (u.res = _(n, a, i)),
            u) : u
        }
        ...
        function q(n, e) {
            var r = e[0].split("")
              , o = []
              , t = e.splice(1);
            for (var a in E("stroke", t),
            n)
                for (var i = 0; i < r.length; i++)
                    r[i] && -1 !== n[a].indexOf(r[i]) && (r[i] = "",
                    o[i] = parseInt(a));
          ...
          , E = function(n, e, r) {
            if (g.check)
                if (A)
                    ...
                    -1 === g.plugins.indexOf("trad") && (d(e, "simple") && i.push("simple"),
                    d(e, "trad") && i.push("trad")),
                    "spell" === n ? d(e, "up") && d(e, "low") && i.push("low") : "stroke" === n ? d(e, "order") ? (l("array", u),
        ...
        var I = function(n, e, r) {
            ...
            var o, t, a = n[n.length - 1], u = -1, l = !1;
            parseInt(a).toString() === a ? (n = n.substr(0, n.length - 1),
            u = (t = i(n)).index,
            o = parseInt(a),
            l = !0,
            e && (n = _(n, u - 1, o))) : (u = (t = i(n)).index,
            o = t.tone,
            e || 0 === o || (n = t.spell));
                ...
                if (o instanceof Array)
                    ...
                    if ((e = e).length >= 1) {
                        for (var l = 0; l < e.length; l++) {
                            var s = e[l];
                            if (s.spell === i.spell && s.tone === i.tone)
                                return
                        }
                        a || (a = !0)
                    }
                    var f = "" + r + (i.tone + (a ? 5 : 0));
                    if (n[i.spell] = u ? u + f : i.index + ":" + f,
                    1 === e.length) {
                        var c = e[0];
        ...
        function U(n) {
            ...
            return a.simple || a.trad || (a.simple = a.trad = !0),
            a.simple && (o += B(n, t.stroke)),
            a.trad && J.dict.getTradCount && (o += B(n, J.dict.getTradCount())),
        ...
        var dn, gn, vn, yn, mn, xn = fn(fn({
            ...
            spellToWord: function() {
                ...
                var i = o.transformTone(r, !1)
                  , u = n.splice(1);
                o.checkArgs("spellToWord", u);
                var l = {
                    simple: o.has(u, a.simple),
                    trad: o.has(u, a.trad),
                    poly: o.has(u, a.poly),
                    alltone: o.has(u, a.alltone)
                };
                l.simple || l.trad || (l.simple = l.trad = !0);
                for (var s = "", f = t.spell[i.spell].substr(2), c = 0; c < f.length; c += 2) {
                    var p = f[c]
                      , h = parseInt(f[c + 1])
                      , d = h > 4;
                    d && (h -= 5),
                    -1 !== s.indexOf(p) || !l.alltone && h !== i.tone || l.poly && !d || (s += p)
                }
                if (l.trad && o.convert) {
                    var g = "";
                ...
                return o.has(u, a.array) ? s.split("") : s
            },
            strokeToWord: U,
            spellInfo: i,
        ...
        g = xn,
        o = (mn = xn)._,
        i.tones = o.tones.split(""),
        i.initials = t.info.initial,
        mn.spellInfo = i,
        mn.type.spellToWord = a,
        function(n) {
            n.strokeToWord = U,
